...
from src.controller_types import RL_TSC, TRADITIONAL_TSC
...
class DistProcs:
    def __init__(self, args, tsc, mode):
        ...
        if tsc in RL_TSC:
            ...
            raise ValueError('Input argument tsc '+str(tsc)+' not found, please provide valid tsc.')
