...
from src.controller_types import SUPPORTED_TSC
...
def parse_cl_args():
    ...
    ##sumo params
    parser.add_argument("-sim", type=str, default='double', dest='sim', help='simulation scenario, options: single, double')
    ...
    parser.add_argument("-mode", type=str, default='train', choices=['train', 'test'], dest='mode', help='reinforcement mode, train (agents receive updates) or test (no updates), default:train, options: train, test'  )
    parser.add_argument("-tsc", type=str, default='websters', choices=SUPPORTED_TSC, dest='tsc', help='options: websters, sotl, dqn, ddpg, ppo')
    ...
    parser.add_argument("-save_path", type=str, default='Outputs/saved_models', dest='save_path', help='dir to save neural network weights, default: Outputs/saved_models')
    parser.add_argument("-save_replay", type=str, default='Outputs/saved_replays', dest='save_replay', help='dir to save experience replays, default: Outputs/saved_replays')
    ...
    # Add PPO-specific params:
    parser.add_argument("-clip", type=float, default=0.2, dest='clip_ratio', help='PPO clip ratio, default: 0.2')
    parser.add_argument("-ppo_epochs", type=int, default=10, dest='ppo_epochs', help='PPO update epochs per batch, default: 10')
    parser.add_argument("-entropy_coef", type=float, default=0.01, dest='entropy_coef', help='PPO entropy bonus coefficient, default: 0.01')
    parser.add_argument("-marl_coord", default=False, action='store_true', dest='marl_coord', help='enable MARL neighbour coordination')
